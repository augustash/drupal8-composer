...
class ExoIconPackageListBuilder extends DraggableListBuilder {
  ...
  public function buildHeader() {
    $header['label'] = $this->t('eXo Icon Package');
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    $row['label'] = Link::fromTextAndUrl(
      $this->t('<strong>@label</strong> <small>(.@machine)</small>', ['@label' => $entity->label(), '@machine' => $entity->getIconId()]),
      new Url('entity.exo_icon_package.canonical', [
