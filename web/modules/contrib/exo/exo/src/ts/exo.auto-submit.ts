...
(function ($, Drupal) {
  ...
  Drupal.behaviors.exoAutoSubmit = {
    ...
    attach: function (context) {
      ...
      $('[data-exo-auto-submit-full-form] input:text, input:text[data-exo-auto-submit]', context)
        .filter(':not([data-exo-auto-submit-exclude])')
        .once('exo.auto-submit').each((index, element) => {
          let timeoutID = 0;
          $(element)
            .bind('keydown keyup', e => {
