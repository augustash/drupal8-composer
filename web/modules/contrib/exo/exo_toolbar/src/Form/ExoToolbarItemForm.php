...
class ExoToolbarItemForm extends EntityForm {
   ...
   *   The plugin form manager.
   */
  public function __construct(EntityManagerInterface $entity_manager, PluginFormFactoryInterface $plugin_form_manager) {
    $this->storage = $entity_manager->getStorage('exo_toolbar_item');
