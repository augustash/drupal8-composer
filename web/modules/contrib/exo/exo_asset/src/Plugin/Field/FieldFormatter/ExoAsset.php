 ...
 * )
 */
class ExoAsset extends EntityReferenceFormatterBase implements ContainerFactoryPluginInterface {
   ...
   *   The module handler.
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, $label, $view_mode, array $third_party_settings, EntityManagerInterface $entity_manager, FieldTypePluginManager $field_type_manager, FormatterPluginManager $field_formatter_manager, ModuleHandlerInterface $module_handler) {
  ...
  protected function getFieldDefinitions($bundle, $field_name) {
    $field_definitions = $this->entityManager->getFieldDefinitions('media', $bundle);
