...
class ExoModalRenderedEntity extends RenderedEntity {
   ...
   *   The eXo modal generator.
   */
  public function __construct(array $options, $plugin_id, array $plugin_definition, EntityManagerInterface $entity_manager, LanguageManagerInterface $language_manager, ExoSettingsInterface $exo_modal_settings, ExoModalGeneratorInterface $exo_modal_generator) {
    parent::__construct($options, $plugin_id, $plugin_definition, $entity_manager, $language_manager);
